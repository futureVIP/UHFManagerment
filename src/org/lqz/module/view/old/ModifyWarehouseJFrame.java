package org.lqz.module.view.old;
...
import org.lqz.module.view.CommunicationParameterManagerJPanel;
...
public class ModifyWarehouseJFrame extends JFrame implements MouseListener {
	...
	JTable table;
	int selectedRow;
	CommunicationParameterManagerJPanel parentPanel;

	public ModifyWarehouseJFrame(CommunicationParameterManagerJPanel parentPanel, JTable table, int selectedRow) {
		this.table = table;
