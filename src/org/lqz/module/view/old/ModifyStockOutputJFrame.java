...
import org.lqz.module.view.DeviceParamsManagerJPanel;
...
public class ModifyStockOutputJFrame extends JFrame implements MouseListener {
	...
	JTable table;
	int selectedRow;
	DeviceParamsManagerJPanel parentPanel;

	public ModifyStockOutputJFrame(DeviceParamsManagerJPanel parentPanel, JTable table, int selectedRow) {
		this.table = table;
