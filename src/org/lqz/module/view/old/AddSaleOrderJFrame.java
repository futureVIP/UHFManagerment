...
import org.lqz.module.view.BasicOperationManagerJPanel;
...
public class AddSaleOrderJFrame extends JFrame implements MouseListener, ActionListener {
	...
	JTable table;
	int selectedRow;
	BasicOperationManagerJPanel parentPanel;

	// 用户对象
	User user;

	public AddSaleOrderJFrame(User user, BasicOperationManagerJPanel parentPanel) {
		this.user = user;
