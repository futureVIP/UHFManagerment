...
import org.lqz.module.view.TagOperationManagerJPanel;
...
public class ModifyStockInputJFrame extends JFrame implements MouseListener {
	...
	JTable table;
	int selectedRow;
	TagOperationManagerJPanel parentPanel;

	public ModifyStockInputJFrame(TagOperationManagerJPanel parentPanel, JTable table, int selectedRow) {
		this.table = table;
