...
import org.lqz.module.view.old.AddStockOutputJFrame;
import org.lqz.module.view.old.ModifyStockOutputJFrame;

public class DeviceParamsManagerJPanel implements ActionListener, MouseListener, DocumentListener {
	...
	public DeviceParamsManagerJPanel(User user) {
		this.user = user;
